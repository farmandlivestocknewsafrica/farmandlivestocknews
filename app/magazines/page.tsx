...
export default async function MagazinesPage() {
  ...
  return (
    <SiteShell>
      <div className="py-10">
        <h1 className="font-serif text-3xl sm:text-4xl font-bold text-primary mb-8">Magazine Archive</h1>
          ...
          <div className="mb-12">
            ...
            >
              <div className="grid md:grid-cols-2 gap-6">
                {/* Cover Image */}
                <div className="relative h-72 sm:h-80 md:h-96 bg-muted">
                ...
                <div className="p-5 sm:p-6 flex flex-col justify-center">
                  ...
                  <h3 className="font-serif text-2xl sm:text-3xl font-bold text-foreground mb-4 group-hover:text-primary transition">
